...
savefig("./Results/Plots/MRA_BarPlotRhythmicity.png", dpi=450)
...
savefig("./Results/Plots/MRA_Bmal1VSPer2.png", dpi=450)
...
savefig("./Results/Plots/MRA_Bmal1_1stVS2nd.png", dpi=450)
...
legend(loc=0, ncol=2)
tight_layout()
savefig("./Results/Plots/MRA_Per2_1stVS2nd.png", dpi=450)
