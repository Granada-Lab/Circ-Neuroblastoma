...
% Remove directory entries ('.' and '..')
fileList_global = fileList_global(~[fileList_global.isdir]);
fileList_adaptive = fileList_adaptive(~[fileList_adaptive.isdir]);
...
cwt2_extract_ridge(folderPath_global,folderPath_adaptive,AllFiles_global,AllFiles_adaptive,is_bmal,is_per,celllinenames_file,reporters,ClusteringResults_FullDataSet)
