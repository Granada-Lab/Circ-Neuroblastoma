function cwt4_extract_phase_difference(folderPath_adaptive,bmal,per)
...
disp('cwt4_extract_phase_difference.m is executed')

currentFolder = fileparts(mfilename('fullpath'));
% Construct the full path to 'circular statistics' folder containing additional functions
folder2Path = fullfile(currentFolder, 'circular_statistics');
% Add folder2 to MATLAB's search path
addpath(folder2Path);

%define remaining parameters
celllines = {'GIMEN', 'NGP', 'SKNSH', 'SKNBE2'};
...
save('Results/extracted_phase_differences.mat', 'phdiff_all', 'time_all');

%% save calculated parameters.
resultexcel_phdiff = append('Results/extracted_circadian_parameters_by_replicate_Bmal1.xlsx');
...
disp('cwt4_extract_phase_difference.m is completed')
