...
#for ii in range(3): #to test out something new 
    ...
    ridge_results_adaptive_th.to_csv("./Data/cwt_ridge_readout_normalized_detrended/Ridge_adaptive_th_"+str(BiolData.columns[ii])+".csv") 
    ridge_results_global_th.to_csv("./Data/cwt_ridge_readout_unnormalized_detrended/Ridge_global_th_"+str(BiolData.columns[ii])+".csv")        
