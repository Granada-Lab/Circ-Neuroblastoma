...
marker_dict = {'CHP212': "o", 'CLBGA':"v",  'GIMEN':"^",  'IMR5':"<",  'Kelly':">",  'Lan5':"s",  'NGP':"p",  'SKNAS':"P",  'SKNBE':"*", 'SKNBE2':"h", 'SKNSH':"X", 'SY5Y':"d", 'U2OS':"D", 'U2OSCRY1sKO':"8", "U2OSCRY12dKO":"H"}
...
if sort_out_U2OS:
    celllines_ = ["SKNSH", "NGP", "GIMEN", "SKNBE2", "CLBGA", "Lan5", "SKNAS", "SY5Y", "Kelly", "SKNBE", "IMR5", "CHP212"]
    celllines_ticks = ["SKNSH", "NGP", "GIMEN", "SKNBE2", "CLBGA", "Lan5", "SKNAS", "SY5Y", "Kelly", "SKNBE", "IMR5", "CHP212"]
else:
    celllines_ = ["U2OS",  "SKNSH", "NGP", "GIMEN", "U2OSCRY1sKO", "SKNBE2", "CLBGA", "Lan5", "SKNAS", "U2OSCRY12dKO", "SY5Y", "Kelly", "SKNBE", "IMR5", "CHP212"]
    celllines_ticks = ["U-2 OS", "SKNSH", "NGP", "GIMEN", "CRY1-KO", "SKNBE2", "CLBGA", "Lan5", "SKNAS", "CRY1/2-dKO", "SY5Y", "Kelly", "SKNBE", "IMR5", "CHP212"]
